    ...
    <div class="login">
        ...
        <div class="container-login">
            <div class="wrap-login">
                <form class="login-form validate-form" id="form-login-coord" action="" method="post">
                    <img src="../img/LOGOS VECTOR_CONECTA.png" alt="" width="300">
                    <h3 class="h4 text-center">Coordinador</h3>
                    ...
                    <div class="container-login-form-btn">
                        <a href="../index.php" class="btn btn-outline-primary">Administrador</a>
                    </div>
                </form>
            </div>
